...
def encoder(i):
    ...
    d1 = res_blk('group0', d1, [ 64,  64,  256], [1, 5, 1], 3, strides=1)                       
    
    d2 = res_blk('group1', d1, [128, 128,  512], [1, 5, 1], 4, strides=2)

    d3 = res_blk('group2', d2, [256, 256, 1024], [1, 5, 1], 6, strides=2)
  
    d4 = res_blk('group3', d3, [512, 512, 2048], [1, 5, 1], 3, strides=2)
